...
class _DischargeSheetState extends State<DischargeSheet> {
  ...
  Future<void> _fetchDischargeData() async {
    try {
      ...
      final diagnosticResponse = await http.get(
        Uri.parse(
      ...
      if (diagnosticResponse.statusCode == 200) {
        final diagnosticData = jsonDecode(diagnosticResponse.body);
        setState(() {
          diagnosticReports = diagnosticData;
        });
      } else {
        setState(() {
          _errorMessage = 'No diagnostic reports available yet because patient is not discharged yet.';
        });
      }
    } catch (e) {
      setState(() {
  ...
  Widget build(BuildContext context) {
    final isNotDischarged = dischargeDetails == null ||
        dischargeDetails!['Discharge_date'] == null ||
        dischargeDetails!['Discharge_date'].toString().isEmpty ||
        dischargeDetails!['Discharge_time'] == null ||
        dischargeDetails!['Discharge_time'].toString().isEmpty;
        ...
        child: Column(
          ...
          children: [
            ...
            _buildDetailCard(
              ...
              iconColor: const Color(0xFF103683),
              label: 'Date',
              value: formattedDate,
            ),
